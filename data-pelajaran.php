      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <a class="nav-item nav-link active"  href="data-pelajaran.php">Courses</a>
            ...
            <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
              <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                  ...
                  <a href="data-guru.php" class="list-group-item list-group-item-action py-2 ripple  " aria-current="true">
                  ...
                  <a href="data-pelajaran.php" class="list-group-item list-group-item-action py-2 ripple active">
...
<!--Main layout-->
          <main style="margin-top: 58px;">
            ...
            <h1 class="text-center my-5 pt-5">Tabel data Pelajaran Saat ini</h1>
            <section class="mx-auto w-75 p-4 ">
              <!-- tabel starts -->
                <table class="table table-bordered mt-4 mx-3 bg-light">
                  ...
                  <tbody>
                    ...
                    $jumlah=0;
                    include "koneksi.php";
                    $a = "SELECT * FROM pelajaran INNER JOIN guru ON pelajaran.idguru = guru.idguru JOIN user ON guru.nip=user.id";
                    $b=$koneksi->query($a);
                    ...
                    <tr>
                      <td><?php echo $no++; ?></td>
                      <td><?php echo $c['id_pelajaran']; ?></td>
                      <td><?php echo $c['nama']; ?></td>
                      <td><?php echo $c['namadepan']; ?> <?php echo $c['namabelakang']; ?></td>
                      <td><i>
                        <a href='edit-pelajaran.php?id_pelajaran=<?php echo $id_pelajaran ?>'>Edit</a> / 
                        </form>
                        <form action="delete-pelajaran.php">
                          <input type="hidden" name="id_pelajaran" value="<?php echo $c['id_pelajaran']; ?>">
                          <a href="delete-pelajaran.php?id_pelajaran=<?php echo $c['id_pelajaran']; ?>">Hapus</a>
                        </form>
                        </i></td>
                    </tr>
              ...
              <!-- tabel ends -->
              <!-- buttons -->
              <a href="pelajaran.php" class="btn btn-primary">Tambah Data</a>
              <!-- buttons ends -->
