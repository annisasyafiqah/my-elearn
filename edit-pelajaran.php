...
<h1 class="mt-5" style="text-align: center;">Edit Data Pelajaran</h1>
 <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 mx-auto mt-5">
      <form action="update-pelajaran.php" method="POST" >
    <!-- Name input -->
        <div class="form-outline mb-4 mx-auto">
          <input type="text" id="form4Example1" name="id_pelajaran" class="form-control" value="<?php echo $c['id_pelajaran'];?>" readonly/>
          <label class="form-label" for="form4Example1">ID Pelajaran</label>
        </div>

    <!-- Name input -->
        <div class="form-outline mb-4">
          <input type="text" id="form4Example2" name="nama" class="form-control" value="<?php echo $c['nama'];?>" />
    ...
    <!-- select input -->
        <select class="form-select mb-4" name="idguru" aria-label="Default select example">
          <option selected><?php echo $c['namadepan']; ?> <?php echo $c['namabelakang']; ?></option>
       <?php }} ?>             

              <?php 
              $e = "SELECT * FROM user INNER JOIN guru ON user.id=guru.nip";
              $f=$koneksi->query($e);
            ...
            <option value="<?php echo $g['idguru']; ?>">
            <?php echo $g['namadepan']; ?> <?php echo $g['namabelakang']; ?></option>
