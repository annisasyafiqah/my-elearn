        ...
        <div class="card card-registration my-4">
          <div class="row g-0 align-items-center">
              <div class="card-body p-md-5 text-black">
                ...
                <form class="mx-1 mx-md-4" action="act_add_info.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                  <input type="date" name="tanggal" id="inputId" class="form-control form-control-lg" />
                  <label class="form-label" for="inputId">Tanggal</label>
                </div>

                <div class="form-outline mb-4">
                  <textarea name="konten" id="inputaddress" rows="20" cols="130"></textarea>
