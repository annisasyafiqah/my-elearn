          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase text-center">Register as student</h3>

                <form class="mx-1 mx-md-4" action="act_regist-siswa.php" method="POST" enctype="multipart/form-data">
                <div class="form-outline mb-4">
                  <select class="form-select mb-4" name="nis" aria-label="Default select example">
                    <option selected>pilih NIS anda</option>
                      <?php 
                        $no=1;
                        $jumlah=0;
                        include "koneksi.php";
