...
<!-- Navbar Start -->
            ...
            <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
              <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                  ...
                  <a href="data-kelas.php" class="list-group-item list-group-item-action py-2 ripple active">
  ...
  <!--Main layout-->
          <main style="margin-top: 58px;">
            ...
            <h1 class="text-center my-5 pt-5 ">Tabel data Kelas Saat ini</h1>
                ...
                <table class="table table-bordered mx-3">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $c['kode_kelas']; ?></td>
                      <td>
                        <a href='edit-kelas.php?kode_kelas=<?php echo $c['kode_kelas']; ?>'>Edit</a>
                        <a href="delete-kelas.php?kode_kelas=<?php echo $c['kode_kelas']; ?>">Hapus</a></td>
                    </tr>
                    <?php
                    }
