      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <a class="nav-item nav-link active ml-2" href="profile-admin.php"><img src="user.png" class="mx-1" width="20px" height="20px" class="mr-2"><?php echo $_SESSION['namadepan'] ?>(<?php echo $_SESSION['level'] ?>) </a>
    ...
    <div class="main mx-4 px-4 container py-5 h-100">
      ...
      <div class="card mx-auto w-75">
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item"><b>ID   :</b> <?php echo $c['id'];?></li>
    ...
    <?php } ?>
      <!-- buttons -->
        <div class="d-flex justify-content-end pt-4">
          <a href="edit-profil-admin.php?nip=<?php echo $_SESSION['id']; ?>" class="btn btn-warning">Edit</a>
