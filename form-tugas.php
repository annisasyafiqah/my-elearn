        ...
        <div class="card card-registration my-4">
          <div class="row g-0 align-items-center">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase text-center">Tugas Baru</h3>

                <form class="mx-1 mx-md-4" action="act_tugas.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                  <input type="date" id="inputnotelp" name="deadline" class="form-control form-control-lg" />
                  <label class="form-label" for="inputnotelp">Batas Pengumpulan</label>
                </div>
