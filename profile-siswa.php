  ...
  <!-- Navbar Ends -->
    ...
    <?php } ?>
        ...
        <div class="d-flex justify-content-end pt-4">
          <a href="edit-profil-siswa.php?nis=<?php echo $_SESSION['id']; ?>" class="btn btn-warning">Edit</a>
