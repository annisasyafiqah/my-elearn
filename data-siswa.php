            ...
            <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
              <div class="position-sticky">
                <div class="list-group list-group-flush mx-3 mt-4">
                  ...
                  <a href="data-siswa.php" class="list-group-item list-group-item-action py-2 ripple active ">
              ...
              <!-- tabel starts -->
                <table class="table table-bordered ">
                  ...
                  <tbody>
                    ...
                    $jumlah=0;
                    include "koneksi.php";
                    $a = "SELECT * FROM siswa INNER JOIN user ON siswa.nis=user.id JOIN kelas ON siswa.kelas=kelas.kode_kelas";
                    $b=$koneksi->query($a);
                    ...
                    <tr>
                      ...
                      <td>
                        <a href='edit-siswa.php?id=<?php echo $c['id']; ?>'>Edit</a>
                        <a href="delete-siswa.php?id=<?php echo $c['id']; ?>">Hapus</a>
                      </td>
