      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <a class="nav-item nav-link"  href="admin-course.php">Courses</a>
            <a class="nav-item nav-link active" href="user.php">Users</a>
          </div>
          ...
          <div class="row g-0">
            ...
            <div class="col-xl-6">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase text-center">Edit Data User</h3>

                <form class="mx-1 mx-md-4" action="update-user.php"  method="POST" enctype="multipart/form-data">
